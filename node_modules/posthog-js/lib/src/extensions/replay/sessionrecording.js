...
var SessionRecording = /** @class */ (function () {
    function SessionRecording(_instance) {
        ...
        this._onOffline = function () {
            _this.tryAddCustomEvent('browser offline', {});
        };
        this._onOnline = function () {
            _this.tryAddCustomEvent('browser online', {});
        };
        ...
        if (this._isRecordingEnabled) {
                ...
                this._removePageViewCaptureHook = this._instance.on('eventCaptured', function (event) {
                    ...
                    try {
                        if (event.event === '$pageview') {
                            ...
                            _this.tryAddCustomEvent('$pageview', { href: href });
                        }
                    }
                    catch (e) {
            ...
            if (!this._onSessionIdListener) {
                this._onSessionIdListener = this._sessionManager.onSessionId(function (sessionId, windowId, changeReason) {
                    var _a, _b, _c, _d;
                    if (changeReason) {
                        _this.tryAddCustomEvent('$session_id_change', { sessionId: sessionId, windowId: windowId, changeReason: changeReason });
    ...
    SessionRecording.prototype.onRemoteConfig = function (response) {
        ...
        this._linkedFlagMatching.onConfig(response, function (flag, variant) {
    ...
    SessionRecording.prototype._clearBufferBeforeMostRecentMeta = function () {
        ...
        for (var i = this._buffer.data.length - 1; i >= 0; i--) {
            if (this._buffer.data[i].type === types_1.EventType.Meta) {
                lastMetaIndex = i;
                break;
            }
        }
